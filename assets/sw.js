 ...
 * page) and the SVG favicon (loads on every page in browsers
 * that prefer the SVG icon). Everything else is cached lazily
 * on first request via the fetch handler's cache-first path.
