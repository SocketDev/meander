...
/* Routes are registered from `lib/admin.ts` so tests can drive
 * them with a stub sqlite client + key context, without pulling
 * in val.town's `https://esm.town/...` imports at test time. */
